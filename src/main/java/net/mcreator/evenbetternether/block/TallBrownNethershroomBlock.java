...
public class TallBrownNethershroomBlock extends DoublePlantBlock implements BonemealableBlock {
	...
	public void performBonemeal(ServerLevel world, RandomSource random, BlockPos pos, BlockState blockstate) {
		TallBrownNethershroomOnBoneMealSuccessProcedure.execute(world, pos.getX(), pos.getY(), pos.getZ());
	}
}
