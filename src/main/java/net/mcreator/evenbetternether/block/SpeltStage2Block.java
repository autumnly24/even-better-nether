...
import net.mcreator.evenbetternether.procedures.SpeltStage2OnTickUpdateProcedure;
...
public class SpeltStage2Block extends Block implements BonemealableBlock {
	public SpeltStage2Block() {
	...
	public void randomTick(BlockState blockstate, ServerLevel world, BlockPos pos, RandomSource random) {
		...
		SpeltStage2OnTickUpdateProcedure.execute(world, pos.getX(), pos.getY(), pos.getZ());
	}
