...
import net.mcreator.evenbetternether.procedures.SpeltStage1OnTickUpdateProcedure;
...
public class SpeltStage1Block extends Block implements BonemealableBlock {
	...
	public void randomTick(BlockState blockstate, ServerLevel world, BlockPos pos, RandomSource random) {
		...
		SpeltStage1OnTickUpdateProcedure.execute(world, pos.getX(), pos.getY(), pos.getZ());
	}
