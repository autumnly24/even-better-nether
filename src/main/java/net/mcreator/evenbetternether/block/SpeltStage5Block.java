...
import net.mcreator.evenbetternether.procedures.SpeltStage5OnTickUpdateProcedure;
...
public class SpeltStage5Block extends Block implements BonemealableBlock {
	public SpeltStage5Block() {
	...
	public void randomTick(BlockState blockstate, ServerLevel world, BlockPos pos, RandomSource random) {
		...
		SpeltStage5OnTickUpdateProcedure.execute(world, pos.getX(), pos.getY(), pos.getZ());
	}
