...
public class EvenbetternetherMod {
	...
	public EvenbetternetherMod(IEventBus modEventBus) {
		// Start of user code block mod constructor
		// End of user code block mod constructor
		NeoForge.EVENT_BUS.register(this);
		modEventBus.addListener(this::registerNetworking);

		EvenbetternetherModBlocks.REGISTRY.register(modEventBus);

		EvenbetternetherModItems.REGISTRY.register(modEventBus);

		EvenbetternetherModTabs.REGISTRY.register(modEventBus);

		EvenbetternetherModFeatures.REGISTRY.register(modEventBus);
