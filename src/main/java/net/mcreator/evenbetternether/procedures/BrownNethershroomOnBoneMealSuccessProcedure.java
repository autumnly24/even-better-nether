...
public class BrownNethershroomOnBoneMealSuccessProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		...
		world.setBlock(BlockPos.containing(x, y, z), EvenbetternetherModBlocks.TALL_BROWN_NETHERSHROOM.get().defaultBlockState(), 3);
		{
			String _value = "lower";
		...
		world.setBlock(BlockPos.containing(x, y + 1, z), EvenbetternetherModBlocks.TALL_BROWN_NETHERSHROOM.get().defaultBlockState(), 3);
		{
			String _value = "upper";
